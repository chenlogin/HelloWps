        ...
        case "btnApiEvent":
            {
                ...
                if (bRegister){
                    wps.ApiEvent.AddApiEventListener('NewPresentation', 'ribbon.OnNewDocumentApiEvent')
                }
                else{
                    wps.ApiEvent.RemoveApiEventListener('NewPresentation', 'ribbon.OnNewDocumentApiEvent')
                }
